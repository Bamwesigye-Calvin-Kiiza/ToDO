...
CSRF_TRUSTED_ORIGINS = ['https://todo-production-df7e.up.railway.app','https://*.127.0.0.1','https://todo-production-0bb0.up.railway.app','https://to-do-task-app.azurewebsites.net']
